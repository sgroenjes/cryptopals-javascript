...
var aesEcb = new aesjs.ModeOfOperation.ecb(keyBuffer);

exports.AES_ECB_Decrypt = function AES_ECB_Decrypt(ciphertext) {
  var lines;
  if(!ciphertext) {
...
exports.AES_ECB_Encrypt = function AES_ECB_Encrypt(plaintext) {
